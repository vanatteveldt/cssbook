...
::: {#exm-text}
Internal representation of texts.
...
you either need to use one of Pandas methods shown below or use a *for loop* or *list comprehension* to iterate over all the strings (see also section 3.2).
...
: Regular expression syntax {#tbl-regexample}
...
: Regular expression syntax in Python and R {#tbl-regextract}
...
If we  want to extract e.g. all hashtags from each tweet, we cannot simply add a "tags" column,
