...
At the time of writing this chapter for the published book, `quanteda` and `caret` were our packages of choice for machine learning and text analysis in R,
...
See the relevant github issues for [tidytext](https://github.com/vanatteveldt/cssbook/issues/5) and [tidymodels](https://github.com/vanatteveldt/cssbook/issues/5) for more information. 
:::
