...
At the time of writing this chapter, `quanteda` was our package of choice for text analysis in R.
...
See [the draft updated version of this chapter](https://v2.cssbook.net/content/chapter10.html) and/or the [relevant github issue](https://github.com/vanatteveldt/cssbook/issues/5) for more information. 
:::
...
in this case the famous haiku "the sound of water" by Bashō.
